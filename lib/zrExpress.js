...
const wilayaToTerritoryId = {
  ...
  "Alger": "a7e764cf-e9ca-4c1f-8232-89852d102aec", // Blida as fallback
  ...
  try {
    ...
    if (wilayaTerritory) {
      ...
      return {
        ...
        districtTerritoryId: districtTerritory?.id,
      };
    }
    ...
    if (!wilaya) {
      ...
      // Try fallback to wilayaToTerritoryId mapping
      ...
      if (territoryId) {
        ...
        return {
          ...
          districtTerritoryId: undefined,
        };
      }
      // For wilayas not in ZR Express, use Blida as fallback
