...
function getDefaultWilayas() {
  return [
    { name: "Adrar", code: 1, homePrice: 0, officePrice: 0 },
    { name: "Chlef", code: 2, homePrice: 0, officePrice: 0 },
    { name: "Laghouat", code: 3, homePrice: 0, officePrice: 0 },
    { name: "Oum El Bouaghi", code: 4, homePrice: 0, officePrice: 0 },
    { name: "Batna", code: 5, homePrice: 0, officePrice: 0 },
    { name: "Béjaïa", code: 6, homePrice: 0, officePrice: 0 },
    { name: "Biskra", code: 7, homePrice: 0, officePrice: 0 },
    { name: "Béchar", code: 8, homePrice: 0, officePrice: 0 },
    { name: "Blida", code: 9, homePrice: 0, officePrice: 0 },
    { name: "Bouïra", code: 10, homePrice: 0, officePrice: 0 },
    { name: "Tamanrasset", code: 11, homePrice: 0, officePrice: 0 },
    { name: "Tébessa", code: 12, homePrice: 0, officePrice: 0 },
    { name: "Tlemcen", code: 13, homePrice: 0, officePrice: 0 },
    { name: "Tiaret", code: 14, homePrice: 0, officePrice: 0 },
    { name: "Tizi Ouzou", code: 15, homePrice: 0, officePrice: 0 },
    { name: "Alger", code: 16, homePrice: 0, officePrice: 0 },
    { name: "Djelfa", code: 17, homePrice: 0, officePrice: 0 },
    { name: "Jijel", code: 18, homePrice: 0, officePrice: 0 },
    { name: "Sétif", code: 19, homePrice: 0, officePrice: 0 },
    { name: "Saïda", code: 20, homePrice: 0, officePrice: 0 },
    { name: "Skikda", code: 21, homePrice: 0, officePrice: 0 },
    { name: "Sidi Bel Abbès", code: 22, homePrice: 0, officePrice: 0 },
    { name: "Annaba", code: 23, homePrice: 0, officePrice: 0 },
    { name: "Guelma", code: 24, homePrice: 0, officePrice: 0 },
    { name: "Constantine", code: 25, homePrice: 0, officePrice: 0 },
    { name: "Médéa", code: 26, homePrice: 0, officePrice: 0 },
    { name: "Mostaganem", code: 27, homePrice: 0, officePrice: 0 },
    { name: "M'Sila", code: 28, homePrice: 0, officePrice: 0 },
    { name: "Mascara", code: 29, homePrice: 0, officePrice: 0 },
    { name: "Ouargla", code: 30, homePrice: 0, officePrice: 0 },
    { name: "Oran", code: 31, homePrice: 0, officePrice: 0 },
    { name: "El Bayadh", code: 32, homePrice: 0, officePrice: 0 },
    { name: "Illizi", code: 33, homePrice: 0, officePrice: 0 },
    { name: "Bordj Bou Arréridj", code: 34, homePrice: 0, officePrice: 0 },
    { name: "Boumerdès", code: 35, homePrice: 0, officePrice: 0 },
    { name: "El Tarf", code: 36, homePrice: 0, officePrice: 0 },
    { name: "Tindouf", code: 37, homePrice: 0, officePrice: 0 },
    { name: "Tissemsilt", code: 38, homePrice: 0, officePrice: 0 },
    { name: "El Oued", code: 39, homePrice: 0, officePrice: 0 },
    { name: "Khenchela", code: 40, homePrice: 0, officePrice: 0 },
    { name: "Souk Ahras", code: 41, homePrice: 0, officePrice: 0 },
    { name: "Tipaza", code: 42, homePrice: 0, officePrice: 0 },
    { name: "Mila", code: 43, homePrice: 0, officePrice: 0 },
    { name: "Aïn Defla", code: 44, homePrice: 0, officePrice: 0 },
    { name: "Naâma", code: 45, homePrice: 0, officePrice: 0 },
    { name: "Aïn Témouchent", code: 46, homePrice: 0, officePrice: 0 },
    { name: "Ghardaïa", code: 47, homePrice: 0, officePrice: 0 },
    { name: "Relizane", code: 48, homePrice: 0, officePrice: 0 },
  ];
}
